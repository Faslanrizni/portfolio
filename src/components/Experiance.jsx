...
const experiences = [
    ...
    {
        company: 'IMS by SollydLabs',
        companyLink: 'https://ims.sollydlabs.com/',
        role: 'Co-Product Owner',
        duration: '2024 – Present',
        workType: 'Product',
        location: 'Remote',
        employmentType: 'Co-owner',
        description: [
            'Defined product direction and priorities for the IMS platform in collaboration with stakeholders and engineering teams.',
            'Worked closely with business users to translate operational needs into clear product requirements and feature roadmaps.',
            'Aligned product development with customer workflows, usability improvements, and platform scalability goals.',
            'Supported cross-functional delivery by prioritizing features, validating requirements, and driving product-focused decision-making.',
        ],
        technologies: ['Product Strategy', 'Requirements Analysis', 'Stakeholder Collaboration', 'Roadmapping', 'Business Operations'],
    },
    {
        company: 'SollydLabs',
        companyLink: 'https://sollydlabs.com/',
